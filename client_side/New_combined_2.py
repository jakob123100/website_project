...
def map_on_day_data(abb_list_1, abb_list_2, abb_list_1_old, abb_list_2_old, temp_c, day_data_list):
...
#day_data_lable_list
#0  "PV day power, kW",
#1  "This day PV energy, kWh",
#2  "Grid day power, kW",
#3  "This day Grid net energy, kWh",
#4  "Battery day power, kW",
#5  "This day Battery net energy, kWh",
#6  "Battery SoC day, %",
#7  "Temp outdoor, C",
#8  "Temp indoor, C",
#9  "Temp heatpump in, C",
#10 "Temp heatpump out, C",
#11 "Temp sauna, C",
#12 "Air pressure, hPa",
#13 "This week PV energy, kWh",
#14 "This month PV energy, kWh",
#15 "This year PV energy, kWh",
#16 "This week Grid net energy, kWh",
#17 "This month Grid net energy, kWh",
#18 "This year Grid net energy, kWh",
#19 "This week House energy, kWh",
#20 "This month House energy, kWh",
#21 "This year House energy, kWh"
#22 "Home day power, kW",
#23 "This day home energy, kWh",
#24 new "This day Grid import energy, kWh"
#25 new "This week Grid import energy, kWh"
#26 new "This month Grid import energy, kWh"
#27 new "This year Grid import energy, kWh"
#28 new "This day Grid export energy, kWh"
#29 new "This week Grid export energy, kWh"
#30 new "This month Grid export energy, kWh"
#31 new "This year Grid export energy, kWh"
 
    dt = datetime.datetime.now()
    #day energy
    if day_data_list[32] != int('{:%d}'.format(dt)):
        day_data_list[1]=0
        day_data_list[3]=0
        day_data_list[23]=0
        day_data_list[5]=0
    ...
    day_data_list[0]=abb_list_2[11]                     #0  "PV day power, kW", = #11 Active power Total 5B14 2 0,01 W Signed
    day_data_list[1]=day_data_list[1]+abb_list_2[0]-abb_list_2_old[0]     #1  "PV cumulative day energy, kWh",
    day_data_list[2]=abb_list_1[11]                     #2  "Grid day power, kW", = #11 Active power Total 5B14 2 0,01 W Signed
    day_data_list[3]=day_data_list[3]+abb_list_1[2]-abb_list_1_old[2]     #3  "Grid cumulative day energy, kWh",
    day_data_list[4]=0                                  #4  "Battery day power, kW",
    day_data_list[5]=0                                  #5  "Battery cumulative day energy, kWh",
    day_data_list[6]=overview_data_list[26]             #6  "Battery SoC day, %",
    day_data_list[7]=temp_c[0]                          #7  "Temp outdoor, C",
    day_data_list[8]=temp_c[1]                          #8  "Temp indoor, C",
    day_data_list[9]=temp_c[2]                          #9  "Temp heatpump in, C",
    day_data_list[10]=temp_c[3]                         #10 "Temp heatpump out, C",
    day_data_list[11]=temp_c[4]                         #11 "Temp sauna, C",
    day_data_list[12]=1013                              #12 "Air pressure, hPa",
    day_data_list[13]=overview_data_list[11]            #13 "This week PV energy, kWh",
    day_data_list[14]=overview_data_list[12]            #14 "This month PV energy, kWh",
    day_data_list[15]=overview_data_list[13]            #15 "This year PV energy, kWh",
    day_data_list[16]=overview_data_list[15]            #16 "This week Grid energy, kWh",
    day_data_list[17]=overview_data_list[16]            #17 "This month Grid energy, kWh",
    day_data_list[18]=overview_data_list[17]            #18 "This year Grid energy, kWh",
    day_data_list[19]=overview_data_list[19]            #19 "This week House energy, kWh",
    day_data_list[20]=overview_data_list[20]            #20 "This month House energy, kWh",
    day_data_list[21]=overview_data_list[21]            #21 "This year House energy, kWh"
    day_data_list[22]=abb_list_1[11] + abb_list_2[11]   #22 "Home day power, kW",
    day_data_list[23]=overview_data_list[18]            #23 "Home cumulative day energy, kWh",
    day_data_list[24]=overview_data_list[4]             #24 new "This day Grid import energy, kWh"
    day_data_list[25]=overview_data_list[5]             #25 new "This week Grid import energy, kWh"
    day_data_list[26]=overview_data_list[6]             #26 new "This month Grid import energy, kWh"
    day_data_list[27]=overview_data_list[7]             #27 new "This year Grid import energy, kWh"
    day_data_list[28]=overview_data_list[8]             #28 new "This day Grid export energy, kWh"
    day_data_list[29]=overview_data_list[9]             #29 new "This week Grid export energy, kWh"
    day_data_list[30]=overview_data_list[27]            #30 new "This month Grid export energy, kWh"
    day_data_list[31]=overview_data_list[28]            #31 new "This year Grid export energy, kWh"
    day_data_list[32]=int('{:%d}'.format(dt))           #32, day energy
